...
/**
 * Parent class for all subcommands in this plugin, registered in FireworksCommandExecutor.
 * @author Omniscimus
 */
public abstract class FireworksCommand {
	 ...
	 * @param args subcommand args (args without the subcommand itself, starting at 0)
	 * @throws PlayerNotOnlineException if a Player specified in args isn't online
	 * @throws SenderIsNotPlayerException if sender must be a Player, and it isn't
	 * @throws NonExistentWorldException if a World specified in args doesn't exist in Bukkit
	 ...
	 * @throws UnsupportedEncodingException if something couldn't be saved to a YAML file
	 */
