...
public class ShootCommand extends FireworksCommand {
	...
	@Override
	public void run(CommandSender sender, String[] args) throws WrongSyntaxException, PlayerNotOnlineException, SenderIsNotPlayerException {
	...
	public void shootFireworks(CommandSender sender, String world, String x, String y, String z) 
		...
		try {
			...
			ShowRunnable.shootFirework(atLocation);
			if(sender != null) sender.sendMessage(ChatColor.GOLD + "Shot fireworks at coordinates " + x + ", " + y + ", " + z + " in world " + world + ".");
		} catch(NumberFormatException e) {
			// Arguments x,y,z weren't proper numbers.
			throw new WrongSyntaxException();
		}
