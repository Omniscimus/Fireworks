...
public class StartCommand extends FireworksCommand {
	...
	@Override
	public void run(CommandSender sender, String[] args) throws WrongArgumentsNumberException, NonExistentWorldException, UnsupportedEncodingException, SenderIsNotPlayerException, PlayerNotOnlineException {
	...
	/**
	 * /fw start
	 * @param sender player at whose location the show should appear and who should be sent a result message.
	...
	/**
	 * /fw start <player>
	 * @param sender player or thing who should be sent a result message. Can be null
	 * @param targetPlayer player at whose location the fireworks show should start
	 * @throws SenderIsNotPlayerException if sender isn't a player, so the location cannot be found
	...
	/**
	 * /fw start <x> <y> <z>
	 * @param sender player or thing from which to get the World and who should be sent a result message
