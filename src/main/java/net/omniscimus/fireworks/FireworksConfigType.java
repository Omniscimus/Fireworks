...
public enum FireworksConfigType {
	...
	CONFIG(null), RUNNINGSHOWS("runningshows.yml"), SAVEDSHOWS("savedshows.yml");
	 ...
	 * @param configFile the File that should be associated with this configtype.
	 */
	 ...
	 * @param fileConfiguration the FileConfiguration that should be associated with this configtype.
	 */
